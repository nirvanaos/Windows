...
public:
	TmpBuf(size_t cnt) : size_(cnt * sizeof(T)),
...
extern "C" BOOL __cdecl WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPCVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesWritten)
{
	static DWORD64 nrvm = 0;
	if (0 == nrvm)
	{
...
extern "C" BOOL __cdecl SetThreadContext64(HANDLE hThread, const _CONTEXT64 *lpContext)
{
